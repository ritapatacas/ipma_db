  ...
  <div class="warning-timeline">
    ...
    <table class="custom-table">
        ...
        <tr class="yellow hover:bg-gray-200 dark:hover:bg-gray-700 transition">
            <td><i class="fa-solid fa-temperature-high"></i></td>
            <td class="level"><i class="fa-solid fa-circle" style="color: #FFD43B;"></i></td>  <!-- 🔥 New: Replaces text with icon -->
            <td><a href="#" onclick="openModal('modal-Tempo-Quente-11-11-06', event)">11-11/06</a></td>
    ...
    <dialog id="modal-Nevoeiro-09-12-06" class="modal">
        ...
        <br><strong>start:</strong> 09/06 11:01
        <br><strong>end:</strong> 12/06 11:00
        <hr>
    ...
    <dialog id="modal-Vento-09-09-06" class="modal">
        ...
        <br><strong>start:</strong> 09/06 12:00
    ...
    <dialog id="modal-Tempo-Quente-11-11-06" class="modal">
        <article>
            <header>
                <a href="#" class="close" aria-label="Close" onclick="closeModal('modal-Tempo-Quente-11-11-06', event)"></a>
                <h3>Tempo Quente</h3>
            </header>
            
        <strong>alert level:</strong> yellow
        <br><strong>start:</strong> 11/06 09:00
        <br><strong>end:</strong> 11/06 21:00
        <hr>
    <p><strong>Leiria (58km WSW)</strong><br>Persistência de valores elevados da temperatura máxima.</p><p><strong>Coimbra (36km NW)</strong><br>Persistência de valores elevados da temperatura máxima.</p>
            <footer>
                <button onclick="closeModal('modal-Tempo-Quente-11-11-06', event)">Close</button>
            </footer>
        </article>
    </dialog>
