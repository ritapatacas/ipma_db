  ...
  <div class="warning-timeline">
    ...
    <table class="custom-table">
        ...
        <tr class="yellow hover:bg-gray-200 dark:hover:bg-gray-700 transition">
            ...
            <td><a href="#" onclick="openModal('modal-Tempo-Quente-09-09-07', event)">09-09/07</a></td>
    ...
    <dialog id="modal-Nevoeiro-09-12-07" class="modal">
        ...
        <br><strong>start:</strong> 09/07 11:21
        <br><strong>end:</strong> 12/07 11:00
        <hr>
    ...
    <dialog id="modal-Tempo-Quente-09-09-07" class="modal">
        <article>
            <header>
                <a href="#" class="close" aria-label="Close" onclick="closeModal('modal-Tempo-Quente-09-09-07', event)"></a>
                <h3>Tempo Quente</h3>
            </header>
    ...
    <p><strong>Castelo Branco (59km ESE)</strong><br>Persistência de valores elevados da temperatura máxima.</p>
            <footer>
                <button onclick="closeModal('modal-Tempo-Quente-09-09-07', event)">Close</button>
            </footer>
        </article>
    </dialog>
