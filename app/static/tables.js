...
window.dashboardTable = `<div class="table-container">
  ...
  <div class="warning-timeline">
    ...
    <dialog id="modal-Nevoeiro-28-01-05" class="modal">
        ...
        <br><strong>start:</strong> 28/04 06:01
    ...
    <dialog id="modal-Precipitação-28-28-04" class="modal">
        ...
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Aguaceiros por vezes fortes, podendo ser de granizo.</p><p><strong>Coimbra (36km NW)</strong><br>Aguaceiros por vezes fortes no interior, podendo ser de granizo.</p>
            <footer>
    ...
    <dialog id="modal-Trovoada-28-28-04" class="modal">
        ...
        <br><strong>end:</strong> 28/04 21:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Condições favoráveis à ocorrência de trovoada.</p><p><strong>Coimbra (36km NW)</strong><br>Trovoada no interior.</p>
            <footer>
