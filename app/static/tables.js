...
window.dashboardTable = `<div class="table-container">
  ...
  <div class="warning-timeline">
    ...
    <dialog id="modal-Nevoeiro-27-30-04" class="modal">
        ...
        <br><strong>start:</strong> 27/04 10:59
        <br><strong>end:</strong> 30/04 10:00
        <hr>
    ...
    <dialog id="modal-Trovoada-28-28-04" class="modal">
        ...
        <br><strong>end:</strong> 28/04 21:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Trovoada.</p><p><strong>Coimbra (36km NW)</strong><br>Trovoada no interior.</p>
            <footer>
