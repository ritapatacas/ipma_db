  ...
  <div class="warning-timeline">
    ...
    <table class="custom-table">
        ...
        <tr class="yellow hover:bg-gray-200 dark:hover:bg-gray-700 transition">
            ...
            <td><a href="#" onclick="openModal('modal-Precipitação-29-29-10', event)">29-29/10</a></td>
    ...
    <dialog id="modal-Nevoeiro-29-01-11" class="modal">
        ...
        <br><strong>start:</strong> 29/10 01:56
        <br><strong>end:</strong> 01/11 01:00
        <hr>
    ...
    <dialog id="modal-Precipitação-29-29-10" class="modal">
        <article>
            <header>
                <a href="#" class="close" aria-label="Close" onclick="closeModal('modal-Precipitação-29-29-10', event)"></a>
                <h3>Precipitação</h3>
            </header>
            
        <strong>alert level:</strong> yellow
        <br><strong>start:</strong> 29/10 01:56
        <br><strong>end:</strong> 29/10 15:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Precipitação, por vezes forte e acompanhada de trovoada.</p>
            <footer>
                <button onclick="closeModal('modal-Precipitação-29-29-10', event)">Close</button>
            </footer>
        </article>
    </dialog>
