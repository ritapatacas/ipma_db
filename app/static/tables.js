...
window.dashboardTable = `<div class="table-container">
  ...
  <div class="warning-timeline">
    ...
    <dialog id="modal-Nevoeiro-04-07-03" class="modal">
        ...
        <br><strong>start:</strong> 04/03 07:22
        <br><strong>end:</strong> 07/03 07:00
        <hr>
    ...
    <dialog id="modal-Vento-05-06-03" class="modal">
        ...
        <br><strong>end:</strong> 06/03 19:00
        <hr>
    ...
    <dialog id="modal-Neve-05-06-03" class="modal">
        ...
        <br><strong>end:</strong> 06/03 19:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Queda de neve acima de 14000/1600 metros de altitude, com acumulação da ordem de 10 cm nos pontos mais altos da serra da Estrela.Impactos Prováveis: Perturbação causada por queda de neve com acumulação e possível formação de gelo (p. ex., vias condicionadas ou interditas, danos em estruturas ou árvores, abastecimentos locais prejudicados).</p>
            <footer>
