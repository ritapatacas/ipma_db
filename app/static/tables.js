...
window.dashboardTable = `<div class="table-container">
  ...
  <div class="warning-timeline">
    ...
    <dialog id="modal-Nevoeiro-02-05-12" class="modal">
        ...
        <br><strong>start:</strong> 02/12 19:24
        <br><strong>end:</strong> 05/12 19:00
        <hr>
    ...
    <dialog id="modal-Neve-02-03-12" class="modal">
        ...
        <br><strong>start:</strong> 02/12 19:24
        <br><strong>end:</strong> 03/12 03:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Queda de neve acima de 800/1000 metros, com acumulação que poderá ser da ordem de 10 a 15 cm.Impactos Prováveis: Perturbação moderada causada por queda de neve com acumulação e possível formação de  gelo (p. ex., vias condicionadas ou interditas, danos em estruturas ou árvores, abastecimentos locais prejudicados).</p><p><strong>Coimbra (36km NW)</strong><br>Queda de neve acima de 800/1000 metros, com acumulação que poderá ser da ordem de 10 a 15 cm.Impactos Prováveis: Perturbação moderada causada por queda de neve com acumulação e possível formação de  gelo (p. ex., vias condicionadas ou interditas, danos em estruturas ou árvores, abastecimentos locais prejudicados).</p>
            <footer>
