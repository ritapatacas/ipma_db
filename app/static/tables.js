  ...
  <div class="warning-timeline">
    ...
    <table class="custom-table">
        ...
        <tr class="yellow hover:bg-gray-200 dark:hover:bg-gray-700 transition">
            ...
            <td><a href="#" onclick="openModal('modal-Neve-14-15-04', event)">14-15/04</a></td>
    ...
    <dialog id="modal-Nevoeiro-14-17-04" class="modal">
        ...
        <br><strong>start:</strong> 14/04 18:29
        <br><strong>end:</strong> 17/04 18:00
        <hr>
    ...
    <dialog id="modal-Neve-14-15-04" class="modal">
        <article>
            <header>
                <a href="#" class="close" aria-label="Close" onclick="closeModal('modal-Neve-14-15-04', event)"></a>
                <h3>Neve</h3>
            </header>
            
        <strong>alert level:</strong> yellow
        <br><strong>start:</strong> 14/04 18:29
        <br><strong>end:</strong> 15/04 15:00
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Queda de neve acima de 1000/1200 m, com acumulação até 5 cm, podendo ser até 10 cm nos pontos mais altos.Impactos Prováveis: Perturbação causada por queda de neve com acumulação e possível formação de gelo (p. ex., vias condicionadas ou interditas, danos em estruturas ou árvores, abastecimentos locais prejudicados).</p>
            <footer>
                <button onclick="closeModal('modal-Neve-14-15-04', event)">Close</button>
            </footer>
        </article>
    </dialog>
