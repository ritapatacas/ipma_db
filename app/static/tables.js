...
window.dashboardTable = `<div class="table-container">
  ...
  <div class="warning-timeline">
    ...
    <dialog id="modal-Nevoeiro-01-04-12" class="modal">
        ...
        <br><strong>start:</strong> 01/12 07:22
        <br><strong>end:</strong> 04/12 07:00
        <hr>
    ...
    <dialog id="modal-Neve-02-03-12" class="modal">
        ...
        <hr>
    <p><strong>Castelo Branco (59km ESE)</strong><br>Queda de neve com acumulação acima de 1600 metros, que poderá ser de 10 cm na Torre.Impactos Prováveis: Perturbação causada por queda de neve com acumulação e possível formação de gelo (p. ex., vias condicionadas ou interditas, danos em estruturas ou árvores, abastecimentos locais prejudicados).</p>
            <footer>
